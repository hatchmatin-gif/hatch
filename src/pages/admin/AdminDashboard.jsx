  ...
  return (
    <div className="admin-layout">
      <style>{`
        ...
        .page-header h1 { font-size: 2.6rem; font-weight: 950; letter-spacing: -2px; line-height: 1; margin: 0; margin-top: -22px; }
        .page-header p { color: #888; font-weight: 500; font-size: 1.1rem; line-height: 1; margin: 0; margin-top: 6px; }
